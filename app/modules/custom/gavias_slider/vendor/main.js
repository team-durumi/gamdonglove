       ...
       var $slider_wrapper = $(this),
         ...
         if(!$fade) $fade = false;
          var swiper_main = $slider_wrapper.find('.swiper-wrapper').slick({
            ...
            infinite: true,
            arrows: $arrows,
            prevArrow: '<a class="slick-prev text-center"><i class="fa fa-angle-left fa-3x">&nbsp;</i></a>',
            nextArrow: '<a class="slick-next text-center"><i class="fa fa-angle-right fa-3x" style="margin-left: 8px">&nbsp;</i></a>',
            cssEase: 'ease',
            easing: 'easeOutQuint',
            edgeFriction: 0.35,
